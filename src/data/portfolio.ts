...
export const services = [
  {
    ...
    icon: "🌐",
    description: "Build modern, scalable full-stack web applications with cutting-edge frontend frameworks and robust backend infrastructure. From responsive UI to secure APIs and database design.",
    pillars: [
      "React/Next.js",
      "Node.js/Express",
      "MongoDB/Mongoose",
  ...
  },
  {
    ...
    icon: "📱",
    description: "Build high-performance cross-platform mobile applications using React Native CLI and Expo. From UI components to backend integration with state management and real-time data synchronization.",
    pillars: [
      "React Native CLI",
      "Expo SDK",
      "iOS & Android",
  ...
  },
  {
    ...
    icon: "🤖",
    description: "Develop and deploy end-to-end machine learning solutions from data preprocessing to production deployment. Specialized in deep learning, NLP, computer vision, and predictive analytics.",
    pillars: [
  ...
  },
  {
    ...
    icon: "🔄",
    description: "Automate your deployment workflow with continuous integration and delivery pipelines for faster, reliable releases.",
    pillars: ["GitHub Actions", "Automated testing", "Zero-downtime deployment"],
    span: "col-span-1",
  },
  {
    title: "Deployment & Infrastructure",
    icon: "🚀",
    description: "End-to-end deployment solutions with cloud infrastructure setup, server configuration, containerization, and continuous monitoring for high availability and performance.",
    pillars: [
      "Azure/AWS/GCP",
      "VPS Configuration",
